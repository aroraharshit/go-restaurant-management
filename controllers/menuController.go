...
func GetMenus() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		defer cancel()
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "error occured while getting list of menu"})
		}
		var allMenus []bson.M
...
func UpdateMenu() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if menu.Start_Date != nil && menu.EndDate != nil {
			if !inTimeSpan(*menu.Start_Date, *menu.EndDate, time.Now()) {
